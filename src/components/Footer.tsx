export default function Footer() {
  ...
  return (
    <footer className="relative bg-black border-t border-green-500/15">
      {/* Main Footer Content */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <button
                ...
                className="w-10 h-10 rounded-lg bg-white/5 border border-green-500/20 flex items-center justify-center hover:bg-green-500/10 hover:border-green-500/40 transition-all duration-300 hover:scale-110 group"
              >
              ...
              <button
                ...
                className="w-10 h-10 rounded-lg bg-white/5 border border-green-500/20 flex items-center justify-center hover:bg-green-500/10 hover:border-green-500/40 transition-all duration-300 hover:scale-110 group"
              >
                <svg className="w-5 h-5 text-gray-400 group-hover:text-green-400 transition-colors duration-300" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
