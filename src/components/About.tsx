      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-green-500/20">
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                Money Plant Club is a <span className="text-green-400 font-semibold">student-led initiative</span> focused on 
                <span className="text-green-400 font-semibold"> financial awareness</span>, 
                <span className="text-green-400 font-semibold"> entrepreneurship</span>, and 
                <span className="text-green-400 font-semibold"> wealth management</span>.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                We aim to <span className="text-green-400 font-semibold">bridge the gap</span> between 
                technical education and financial literacy, empowering students with real-world money management skills.
              </p>
            </div>

            {/* Tabs */}
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl border border-green-500/20 overflow-hidden">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
                      <div className="text-center p-4 bg-green-500/10 rounded-lg border border-green-500/20">
                        <div className="w-8 h-8 mx-auto mb-2 text-green-400 modern-icon">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-green-500/20 to-green-600/10 backdrop-blur-lg rounded-2xl p-8 border border-green-500/20 h-full min-h-[400px] flex items-center justify-center">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="professional-card">
            ...
            <h3 className="text-xl font-semibold mb-2 text-green-400">Focus Areas</h3>
          ...
          <div className="professional-card">
            ...
            <h3 className="text-xl font-semibold mb-2 text-green-400">Bridge Education</h3>
          ...
          <div className="professional-card">
            ...
            <h3 className="text-xl font-semibold mb-2 text-green-400">Student Led</h3>
