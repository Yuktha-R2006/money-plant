                  ...
                  <div className={`flex justify-center space-x-3 transition-all duration-300 ${
                    ...
                    {member.social.linkedin && (
                      <button
                        ...
                        className="w-10 h-10 rounded-full bg-gray-700/50 border border-gray-600/50 flex items-center justify-center text-gray-400 hover:bg-gray-600/50 hover:text-yellow-400 hover:border-yellow-500/30 transition-colors duration-300"
                      >
